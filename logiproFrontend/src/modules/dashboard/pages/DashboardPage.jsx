...
import { alertInfo as swalInfo } from "../../../components/alerts/swal";
...
export default function DashboardPage() {
  ...
  const lowStockColumns = [
    ...
    { key: "codigo", label: "Código" },        // podés usar "sku" si preferís
  ...
  return (
    <div className="container-fluid py-3">
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <CardStat label="Órdenes pendientes" value={kpis.ordenesPendientes} hint="Por recibir / despachar" />
        </div>
        <div className="col-12 col-sm-6 col-xl-3">
          <CardStat label="Alertas" value={kpis.alertas} hint="Bajo stock / vencimientos" />
        </div>
      </div>
      ...
      <div className="row g-3">
        ...
        {/* Accesos rápidos (inline, luego lo pasamos a componente) */}
        <div className="col-12">
          <div className="card shadow-sm">
            ...
            <div className="card-body d-flex flex-wrap gap-2">
              <button type="button" className="btn btn-primary" onClick={() => handleQuick("Nuevo movimiento")}>
                Nuevo movimiento
              </button>
              <button type="button" className="btn btn-outline-primary" onClick={() => handleQuick("Inventario")}>
                Inventario
              </button>
              <button type="button" className="btn btn-outline-primary" onClick={() => handleQuick("Órdenes")}>
                Órdenes
              </button>
              <button type="button" className="btn btn-outline-primary" onClick={() => handleQuick("Proveedores")}>
                Proveedores
              </button>
            </div>
          </div>
